...
for(i in (1:3)) {
  ...
  ggplot(data = city_data[[i]], aes(x = Zenith_Bins, y = GHI)) +
  ...
  ggplot(data = city_data[[i]], aes(x = Hour, y = `Solar Zenith Angle`, group = interaction(Month, Day), color = factor(Month))) +
    geom_line() +
  ...
  ggplot(data = city_data[[i]], aes(x = Hour, y = GHI, group = interaction(Month, Hour), color = Month)) +
  ...
  ggplot(data = city_data[[i]], aes(x = Cloud_Type, y = GHI)) +
  ...
  ggplot(data = subset(city_data[[i]], `Solar Zenith Angle` >= 0 & `Solar Zenith Angle` <= 80),
